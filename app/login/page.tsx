...
export default function Login() {
  return (
    <div className="bg-[#1F1E28] flex flex-col gap-4 justify-center items-center text-[#2D3846] p-8 md:h-full">
      ...
      <main className="bg-[#F2F5F7] flex flex-col gap-5 p-4 rounded-sm m-auto md:w-120" >
        ...
        <div className="felx flex-col justify-center items-center font-semibold text-zinc-500">
          <p className="text-center mb-6">
            Do you need an<span className="text-[#2AA7FD] cursor-pointer" onClick={() => redirect('/signup')}>account?</span>
          </p>
